...
\begin{table}[H]
\centering
\caption{Empirical clustering summary for the monthly FRED panel, with grid-envelope bootstrap intervals}
...
\toprule
Series & $\widehat{\theta}_{\mathrm{runs}}$ & $\widehat{\theta}_{\mathrm{int}}$ & 90\% envelope & $\widehat{\Lambda}$ & 90\% envelope \\
\midrule

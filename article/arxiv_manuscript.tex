...
\midrule
Finite-level clustering coefficient by series (artifact 04; clustered synthetic, isolated synthetic, logistic benchmark observable) & Clustered synthetic stress: $0.673$; isolated synthetic stress: $0.780$; logistic benchmark observable: $1.000$ \\
Return-time diagnostics (artifact 03; logistic benchmark observable and clustered absolute-GARCH benchmark) & Logistic observable: $249$ return times, normalized CV $0.795$; clustered stress: $149$ return times, normalized CV $1.286$ \\
...
\begin{table}[H]
\centering
\caption{Empirical bootstrap summary for the monthly FRED panel, with a transformed unemployment specification}
...
\midrule
Unemployment rate (level) & $0.048$ & not interpretable ($k=2$) & $2.028$ & not interpretable ($k=2$) \\
Unemployment rate (12m diff.) & $0.095$ & $[0.014,\,0.124]$ & $1.043$ & $[0,\,1.853]$ \\
Baa-Treasury spread & $0.186$ & $[0.093,\,0.209]$ & $0.531$ & $[0.189,\,0.860]$ \\
KCFSI & $0.182$ & $[0,\,0.255]$ & $0.556$ & $[0,\,1.043]$ \\
\bottomrule
\end{tabular}
\normalsize
\end{table}
